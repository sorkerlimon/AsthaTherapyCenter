...
ALLOWED_HOSTS = [
    "localhost",
    "127.0.0.1",
    "asthatherapycenter.com",
    "www.asthatherapycenter.com",
    "*"
]
...
ROOT_URLCONF = 'aastha_therapy_center.urls'
...
WSGI_APPLICATION = 'aastha_therapy_center.wsgi.application'
...
# Custom User Model
AUTH_USER_MODEL = 'astha_therapy_center_web.CustomUser'
